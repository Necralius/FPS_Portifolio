...
/// </summary>
/// 
[CustomPropertyDrawer(typeof(GunShooter), true)]
public class ExtendedScriptableObjectDrawer : PropertyDrawer
{
    string ScriptName = "GunShooter"; //Place the scriptable class name here
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        if (property.isExpanded)
        {
            ...
            if (prop.NextVisible(true))
            {
                do
                {
                    if (prop.name == ScriptName) continue;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.propertyType == SerializedPropertyType.ObjectReference && property.objectReferenceValue != null)
        {
            ...
            GunShooter gunAsset = (GunShooter)data;
            ...
            if (property.isExpanded)
            {
                ...
                #region - Local Gun Settings -
                EditorGUILayout.BeginVertical(GUI.skin.box);

                if (gunAsset == null) return;
                else if (gunAsset.shootType == ShootType.BurstShot)
                {
                    GUILayout.BeginHorizontal();
                    GUILayout.Label("GunBurst Settings", EditorStyles.boldLabel);
                    GUILayout.EndHorizontal();

                    GUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("Shoots Per Tap", GUILayout.MaxWidth(100f));
                    gunAsset.ShootsPerTap = (float)EditorGUILayout.FloatField(gunAsset.ShootsPerTap, GUILayout.MaxWidth(32f));
                    GUILayout.EndHorizontal();
                }
                else if (gunAsset.shootType == ShootType.Shotgun)
                {
                    GUILayout.BeginHorizontal();
                    GUILayout.Label("Shotgun Settings", EditorStyles.boldLabel);
                    GUILayout.EndHorizontal();
                    ...
                    gunAsset.ShootSpread = (float)EditorGUILayout.FloatField(gunAsset.ShootSpread, GUILayout.MaxWidth(32f));
                    GUILayout.EndHorizontal();
                }
    ...
    public static T _GUILayout<T>(string label, T objectReferenceValue, ref bool isExpanded) where T : ScriptableObject => _GUILayout<T>(new GUIContent(label), objectReferenceValue, ref isExpanded);
